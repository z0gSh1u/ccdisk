...
**为 Claude AI 社区用 ❤️ 制作**

[报告 Bug](https://github.com/yourusername/ccdisk/issues) · [请求功能](https://github.com/yourusername/ccdisk/issues) · [文档](https://github.com/yourusername/ccdisk/wiki)

...
describe('CommandsService', () => {
  ...
  describe('deleteCommand', () => {
    ...
    it('should throw when command does not exist', async () => {
      await assert.rejects(async () => await commandsService.deleteCommand('nonexistent.sh', 'global'), {
    ...
    it('should throw when workspace scope is used without workspace path', async () => {
      ...
      await assert.rejects(async () => await serviceWithoutWorkspace.deleteCommand('test.sh', 'workspace'), {
        message: 'No workspace path set'
      });
    });
  ...
  describe('error handling', () => {
    ...
    it('should handle invalid scope in deleteCommand', async () => {
      await assert.rejects(async () => await commandsService.deleteCommand('test.sh', 'invalid' as any), {
        message: 'Invalid scope: invalid'
      });
    });
  });

...
This is the skill body.`;
  ...
  describe('getSkill', () => {
    ...
    it('should throw when workspace scope is used without workspace path', async () => {
      ...
      await assert.rejects(async () => await serviceWithoutWorkspace.getSkill('test', 'workspace'), {
  ...
  describe('createSkill', () => {
    ...
    it('should throw when skill already exists', async () => {
      ...
      await assert.rejects(async () => await skillsService.createSkill('existing', '# New', 'global'), {
    ...
    it('should throw when workspace scope is used without workspace path', async () => {
      ...
      await assert.rejects(async () => await serviceWithoutWorkspace.createSkill('test', '# Test', 'workspace'), {
        message: 'No workspace path set'
      });
    });
...
# Content`;
  ...
  describe('updateSkill', () => {
    ...
    it('should throw when skill does not exist', async () => {
      await assert.rejects(async () => await skillsService.updateSkill('nonexistent', '# New', 'global'), {
    ...
    it('should throw when workspace scope is used without workspace path', async () => {
      ...
      await assert.rejects(async () => await serviceWithoutWorkspace.updateSkill('test', '# New', 'workspace'), {
        message: 'No workspace path set'
      });
    });
  });
  ...
  describe('deleteSkill', () => {
    ...
    it('should throw when workspace scope is used without workspace path', async () => {
      ...
      await assert.rejects(async () => await serviceWithoutWorkspace.deleteSkill('test', 'workspace'), {
        message: 'No workspace path set'
      });
    });
  });
